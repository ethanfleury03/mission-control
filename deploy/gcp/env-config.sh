...
mc_resolve_env() {
  ...
  case "$MC_ENV" in
    prod | production)
      ...
      MC_OUTREACH_DEEP_SYNC_SERVICE="mc-outreach-deep-sync"
      MC_OUTREACH_DEEP_SYNC_SA="mc-outreach-deep-sync-sa"
      MC_OUTREACH_STATE_BUCKET="${MC_OUTREACH_STATE_BUCKET:-}"
      ...
      MC_RAPIDAPI_SECRET="mc-rapidapi-key"
      ...
      MC_OUTREACH_SERVICE_TOKEN_SECRET="mc-outreach-crm-service-token"
      MC_OUTREACH_WEBHOOK_SECRET_SECRET="mc-outreach-crm-webhook-secret"
      MC_OUTREACH_OPENCLAW_GATEWAY_URL_SECRET="mc-outreach-crm-openclaw-gateway-url"
      MC_OUTREACH_OPENCLAW_WEBHOOK_URL_SECRET="mc-outreach-crm-openclaw-webhook-url"
      MC_RETELL_API_SECRET="mc-retell-api-key"
      MC_PHONE_RETELL_AGENT_IDS_SECRET="mc-phone-retell-agent-ids"
      MC_PHONE_RETELL_AGENT_ID_SECRET="mc-phone-retell-agent-id"
      MC_PHONE_RETELL_PROFILE_KEY_SECRET="mc-phone-retell-profile-key"
      MC_PHONE_RETELL_PROFILE_LABEL_SECRET="mc-phone-retell-profile-label"
      MC_PHONE_RETELL_CONVERSATION_FLOW_ID_SECRET="mc-phone-retell-conversation-flow-id"
      MC_PHONE_RETELL_OUTBOUND_NUMBER_SECRET="mc-phone-retell-outbound-number"
      MC_PHONE_RETELL_OUTBOUND_NUMBER_LABEL_SECRET="mc-phone-retell-outbound-number-label"
      MC_PHONE_RETELL_VOICE_LABEL_SECRET="mc-phone-retell-voice-label"
      MC_PHONE_RETELL_WEBHOOK_STATUS_SECRET="mc-phone-retell-webhook-status"
    ...
    stage | staging)
      ...
      MC_OUTREACH_DEEP_SYNC_SERVICE=""
      MC_OUTREACH_DEEP_SYNC_SA=""
      MC_OUTREACH_STATE_BUCKET=""
      ...
      MC_RAPIDAPI_SECRET="mc-stage-rapidapi-key"
      ...
      MC_OUTREACH_SERVICE_TOKEN_SECRET="mc-stage-outreach-crm-service-token"
      MC_OUTREACH_WEBHOOK_SECRET_SECRET="mc-stage-outreach-crm-webhook-secret"
      MC_OUTREACH_OPENCLAW_GATEWAY_URL_SECRET="mc-stage-outreach-crm-openclaw-gateway-url"
      MC_OUTREACH_OPENCLAW_WEBHOOK_URL_SECRET="mc-stage-outreach-crm-openclaw-webhook-url"
      MC_RETELL_API_SECRET="mc-stage-retell-api-key"
      MC_PHONE_RETELL_AGENT_IDS_SECRET="mc-stage-phone-retell-agent-ids"
      MC_PHONE_RETELL_AGENT_ID_SECRET="mc-stage-phone-retell-agent-id"
      MC_PHONE_RETELL_PROFILE_KEY_SECRET="mc-stage-phone-retell-profile-key"
      MC_PHONE_RETELL_PROFILE_LABEL_SECRET="mc-stage-phone-retell-profile-label"
      MC_PHONE_RETELL_CONVERSATION_FLOW_ID_SECRET="mc-stage-phone-retell-conversation-flow-id"
      MC_PHONE_RETELL_OUTBOUND_NUMBER_SECRET="mc-stage-phone-retell-outbound-number"
      MC_PHONE_RETELL_OUTBOUND_NUMBER_LABEL_SECRET="mc-stage-phone-retell-outbound-number-label"
      MC_PHONE_RETELL_VOICE_LABEL_SECRET="mc-stage-phone-retell-voice-label"
      MC_PHONE_RETELL_WEBHOOK_STATUS_SECRET="mc-stage-phone-retell-webhook-status"
